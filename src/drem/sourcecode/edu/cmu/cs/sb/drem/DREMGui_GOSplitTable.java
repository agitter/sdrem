...
public class DREMGui_GOSplitTable extends JPanel implements ActionListener
{
	 ...
	 */    
	public DREMGui_GOSplitTable(final DREMGui theDREMGui, JFrame theFrame,final DREM_Timeiohmm theTimeiohmm,
			DREM_Timeiohmm.Treenode ptr,int nchild)
	{
		...
		tgr = theDataSet.tga.getCategory(theDataSet.genenames,ptr.bInNode,bgenesplit);
		...
		else
		{
			...
			String szcountLabel = 
				"Total number of genes most likely going through this path is "
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		else if (szCommand.equals("help"))
		{
			...
			szMessage += 
				" as compared to what would be expected if the same number of genes as assigned to this "+
			...
			"for the data  #Total_Unique_Split_In="+((int)tgr.dall)+".\n"+
