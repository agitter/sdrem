...
public class ST extends JFrame implements ActionListener
{
    ...
    static String[] chromorganisms = {
     ...
     static String[] organisms = {
                              "User provided",
			      "No annotations",
			      "Anaplasma phagocytophilum HZ (TIGR)",//new
			      "Arabidopsis (EBI)",
			      ...
			      "Carboxydothermus hydrogenoformans Z-2901 (TIGR)",//new
			      "Chicken (EBI)",
			      "Cow (EBI)",
			      ...
			      "Ehrlichia chaffeensis Arkansas (TIGR)",//new
			      ...
			      "Mouse (EBI)",
			      "Mus musculus (MGI)",
			      "Neorickettsia sennetsu Miyayama (TIGR)",//new
       ...
       static String[] gannfile = {
			    ...
			    SZGP+"cgd.gz",
			    SZGP+"tigr_Chydrogenoformans.gz",
			    SZGP +"goa_chicken.gz",
			    SZGP+"goa_cow.gz",
		       ...
		       else
		       {
		        ...
		        szxrefDEF = szvalue;
	                int numitems = defaultxrefs.length;
	                   ...
	                   {
	                      if (((String) defaultxrefs[nsource]).equalsIgnoreCase(szxrefDEF))
	                      {
                                 bfound = true;
                                 nxrefDEF = nsource;
	                      }
...
//			  StatUtil.htbinom = new Hashtable();
        ...
        else if (esource == clusterAButton)
	{
       ...
       {
           String szMessage = "This is version 1.3.4 of the Short Time-series Expression Miner (STEM).\n\n"+
	  ...
	  this.szfile = szfile;
       ...
       public void run()
       {
             ...
             else if (szfile.equals(SZGP+"goa_chicken.gz"))
	     {
             ...
             else if (szfile.equals(SZGP+"goa_cow.gz"))
	     {
   ...
   public class Progressdownload implements Runnable
   {
	...
	if (bshowusage)
	{
	    System.out.println("USAGE: java ST [-d defaultfilename.txt|-b batchInput batchOutputDir]");
            return;
	}
