 ...
 */
public class DREMGui_GOFilter extends JPanel implements ActionListener, ItemListener,ChangeListener
{
	 ...
	 */
	 public DREMGui_GOFilter(JFrame theFrame, DREMGui theDREMGui,DREM_GoAnnotations.RecIDdrem[] dremGOrecs,final DREM_Timeiohmm.Treenode rootptr)
	 {
		 ...
		 for (int nrow = 0; nrow < numrows; nrow++)
		 {
			 ...
			 tabledata[nrow][2] = Util.doubleToSz(dremGOrecs[nrow].dminoverallpval);
			 tabledata[nrow][3] = Util.doubleToSz(dremGOrecs[nrow].dminsplitpval);
		 }
		 ...
		 table.setPreferredScrollableViewportSize(new Dimension(340, 
		 ...
		 rowSM.addListSelectionListener(new ListSelectionListener() {
			 public void valueChanged(ListSelectionEvent e) {
				 ...
				 else 
				 {
					 ...
					 addGOLabels(rootptr);
					 setGOLabelTextVisible(rootptr,ftheDREMGui.bshowgolabels&&
		 ...
		 JLabel theTopLabel = new JLabel("  Only display GO enrichments with a p-value less than 10^-X where X is:");
	 ...
	 public void stateChanged(ChangeEvent e) 
	 {
		 ...
		 if (!source.getValueIsAdjusting()) 
		 {
			 ...
			 pvalLabel.setText("X = "+source.getValue()/10.0+
					 "; p-value threshold is "+DREMGui_KeyInputs.doubleToSz(dgopval));
			 addGOLabels(rootptr);
		 }
	 }
	 ...
	 public void actionPerformed(ActionEvent e) 
	 {
		 ...
		 {
			 String szMessage = 
				 "This window allows one to reduce the set of genes currently displayed "+
		 ...
		 if (treeptr != null)
		 {
			 ...
			 if (nrow >= 0)
			 {
				 ...
				 if (!bsplitgolabels)
				 {
					 ...
					 int ncategoryall = ((Integer) tga.htFullCount.get(szGO)).intValue();
					 int nval = nmatch-1;
					 ...
					 if (dpval <= dgopval)
					 {
						 treeptr.szgolabel = nmatch+";"+Util.doubleToSz(dpval);
					 }
					 else
					 {
						 treeptr.szgolabel = "";
				 ...
				 else if ((treeptr.parent != null) && (treeptr.parent.numchildren >= 2))
				 {
					 ...
					 for (int ngene = 0; ngene < treeptr.bInNode.length; ngene++)
					 {
						 if (treeptr.parent.bInNode[ngene])
						 {
							 ...
							 if (ballgenes||(theDREMGui.bTFVisible[ngene]&&
									 theDREMGui.bSetVisible[ngene]))
							 {
								 if (treeptr.bInNode[ngene])
								 {
