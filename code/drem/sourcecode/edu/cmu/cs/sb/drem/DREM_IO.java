...
public class DREM_IO extends JFrame implements ActionListener, ChangeListener
{
	...
	boolean bbatchMode;
	/** The filename prefix used when saving the model and activites in batch mode */
	String saveFile;
	...
	boolean btraintest;
	boolean[] bdownloading = new boolean[3];
	Object lockpd = new Object();
	Object lockxref = new Object();
	int[] npercentdone = new int[3];
	boolean[] bexception = new boolean[3];
	int nexceptions;
	...
	static	String[] defaultxrefs ={"User provided",
		"No cross references",
		"Arabidopsis (EBI)",
		"Chicken (EBI)",
		"Human (EBI)",
	...
	static	String[] organisms = {"User provided",
		...
		"Schizosaccharomyces pomb (Sanger GeneDB)",
	...
	static	String[] xreffile ={"",
		"",
		"arabidopsis.xrefs.gz",
		"chicken.xrefs.gz",
		"human.xrefs.gz",	      
		"mouse.xrefs.gz",
		"rat.xrefs.gz",
	...
	static String[] gannfile = {"",
		"",
		SZGP+"goa_arabidopsis.gz",
		SZGP+"tair.gz",
		SZGP+"tigr_Banthracis.gz",
		SZGP+"wb.gz",
		SZGP+"tigr_Cjejuni.gz",
		SZGP+"cgd.gz",
		SZGP +"goa_chicken.gz",
		SZGP+"tigr_Cburnetii.gz",
		SZGP+"zfin.gz",
		SZGP+"tigr_Dethenogenes.gz",
		SZGP+"ddb.gz",
		SZGP+"fb.gz",
		SZGP+"tigr_Gsulfurreducens.gz",
		SZGP+"GeneDB_tsetse.gz",
		SZGP+"goa_human.gz",
		SZGP+"GeneDB_Lmajor.gz",
		SZGP+"tigr_Lmonocytogenes.gz",
		SZGP+"tigr_Mcapsulatus.gz",		      
		SZGP+"goa_mouse.gz",
		SZGP+"mgi.gz",
		SZGP+"gramene_oryza.gz",
		SZGP+"goa_pdb.gz",
		SZGP+"GeneDB_Pfalciparum.gz",
		SZGP+"tigr_Psyringae.gz",
		SZGP+"goa_rat.gz",
		SZGP+"rgd.gz",
		SZGP+"sgd.gz",
		SZGP+"GeneDB_Spombe.gz",
		SZGP+"tigr_Soneidensis.gz",
		SZGP+"tigr_Spomeroyi.gz",
		SZGP+"GeneDB_Tbrucei.gz",
		SZGP+"tigr_Tbrucei_chr2.gz",
		SZGP+"goa_uniprot.gz",
		SZGP+"tigr_Vcholerae.gz",
		SZGP+"goa_zebrafish.gz"}; 

	static String[] xreforgfile = {"",
		"",
		"arabidopsis.xrefs.gz",
		"",
		"",
	...
	static String szstaticsearch = "Use transcription factor-gene interaction data to build model ";
	...
	JButton staticFileButton = new JButton("Browse...", Util.createImageIcon("Open16.gif"));
	...
	JButton initfileButton = new JButton("Browse...", Util.createImageIcon("Open16.gif"));
	...
	JButton staticsourceHButton =new JButton(Util.createImageIcon("Help16.gif"));
	...
	JButton staticsearchHButton = new JButton(Util.createImageIcon("Help16.gif"));
	...
	JButton modelframeworkHButton = new JButton(Util.createImageIcon("Help16.gif"));
	JButton convergencePanelHButton = new JButton(Util.createImageIcon("Help16.gif"));

	JButton optionsButton = new JButton("Options...", Util.createImageIcon("Preferences16.gif"));
	...
	/**
	 * Class constructor - builds the input interface
	 * calls parseDefaults to get the initial settings from a default settings file
	 * if specified
	 */
	public DREM_IO() throws FileNotFoundException, IOException
	{
		super("DREM - Dynamic Regulatory Events Miner (development version)");
		...
		File dir = new File(SZSTATICDIR);
		{
			...
			if (children == null) 
			{
				...
				javax.swing.SwingUtilities.invokeLater(new Runnable() 
				{
					public void run() 
					{
						JOptionPane.showMessageDialog(fframe, "The directory "+SZSTATICDIR+" was not found.", 
		...
		xrefcb =new JComboBox(defaultxrefs);
		...
		contentPane.add(p);
		char ch = (char) 169;
		JLabel copyrightLabel = new JLabel(ch+" 2005, Carnegie Mellon University.  All Rights Reserved.  ");
		...
		theRepeatList =  new ListDialog(this,
				DREM_IO.vRepeatFilesDEF , DREM_IO.balltimeDEF,repeatButton,DREM_IO.lightBlue,
	 ...
	 */
	public static void parseDefaults() throws FileNotFoundException, IOException
	{
		String szLine;
		BufferedReader br;
		try
				...
				if (st.hasMoreTokens())
				{
					...
					if (!szvalue.equals(""))
					{
						if ((sztype.equalsIgnoreCase("Use_static_input_to_build_model"))||
								(sztype.equalsIgnoreCase("Use_transcription_factor-gene_interaction_data_to_build"))||
								(sztype.equalsIgnoreCase("Use_transcription_factor_gene_interaction_data_to_build")))
						{
							...
							else
							{
								...
								sztype.equalsIgnoreCase("TF_gene_Interactions_File")||
								sztype.equalsIgnoreCase("TF-gene_Interactions_File"))
						{
							szStaticFileDEF = szvalue;
						}
						else if (sztype.equalsIgnoreCase("Data_File")
								||sztype.equalsIgnoreCase("Expression_Data_File"))
						{
							szDataFileDEF = szvalue;
						}
						else if (sztype.equalsIgnoreCase("Convergence_Likelihood_%"))
						{
								...
								(sztype.equalsIgnoreCase("Normalize_Data[Log normalize data,Normalize data,No normalization/add 0]")))
						{
							try
							{
								...
								{
									throw new IllegalArgumentException(szvalue+" is an invalid argument for Normalize_Data");	 
								}
							}
							catch(NumberFormatException ex)
							{
								...
								(sztype.equalsIgnoreCase("Change_should_be_based_on")))
						{
						...
						else if (sztype.equalsIgnoreCase("Gene_Annotation_Source"))
						{
							try
							{
								...
								if ((ndbDEF < 0)|| (ndbDEF >= organisms.length))
								{
									ndbDEF = 0;
								}
							}
							catch(NumberFormatException ex)
							{
								...
								int nsource = 0;
								while ((nsource < organisms.length)&&(!bfound))
								{
									if (organisms[nsource].equalsIgnoreCase(szvalue))
									{
										bfound = true;
										ndbDEF = nsource;
									}
						...
						else if (sztype.equalsIgnoreCase("TF-gene_Interaction_Source"))
						{
							...
							catch(NumberFormatException ex)
							{
								...
								{
									if (((String) staticsourceArray[nsource]).equalsIgnoreCase(szvalue))
									{
										bfound = true;
						...
						{
							int numitems = defaultxrefs.length;
							try
							{
							...
							catch(NumberFormatException ex)
							{
								...
								while ((nsource < numitems)&&(!bfound))
								{
									if (((String) defaultxrefs[nsource]).equalsIgnoreCase(szvalue))
									{
										bfound = true;
										nxrefDEF = nsource;
									}
						...
						else if (sztype.equalsIgnoreCase("Y-axis_Scale_Factor"))
						{
							dYaxisDEF = Double.parseDouble(szvalue);
						}
						else if (sztype.equalsIgnoreCase("Scale_Node_Areas_By_The_Factor"))
						{
							dnodekDEF = Double.parseDouble(szvalue);
						}
						else if (sztype.equalsIgnoreCase("X-axis_Scale_Factor"))
						{
						...
						else if(sztype.equalsIgnoreCase("Key_Input_X_p-val_10^-X"))
						{
							dKeyInputXDEF = Double.parseDouble(szvalue);
						}
						else if ((sztype.equalsIgnoreCase("Key_Input_Significance_Based_On["+
						"Path Significance Conditional on Split,Path Significance Overall,Split Significance]"))||
						(sztype.equalsIgnoreCase("Key_Input_Significance_Based_On["+
						"Split Significance,Path Significance Conditional on Split,Path Significance Overall]")))
						{
							try
							{
								...
								if ((nKeyInputTypeDEF < 0)|| (nKeyInputTypeDEF >2))
								{
									throw new IllegalArgumentException(szvalue+
							...
							{
								if (szvalue.equalsIgnoreCase("Split Significance"))
								{
									nKeyInputTypeDEF = 0;
								}
								else if (szvalue.equalsIgnoreCase("Path Significance Conditional on Split"))
								{
									nKeyInputTypeDEF = 1;
								} 
								else if (szvalue.equalsIgnoreCase("Path Significance Overall"))
								{
									nKeyInputTypeDEF = 2;
								}
								else
						...
						else if (sztype.equalsIgnoreCase("Maximum_number_of_paths_out_of_split"))
						{
						...
						else if (sztype.equalsIgnoreCase("Penalized_likelihood_node_penalty"))
						{
								...
								(sztype.equalsIgnoreCase("Model_selection_framework[Penalized Likelihood,Train-Test]")))
						{
							...
							{
								if (szvalue.equalsIgnoreCase("Penalized Likelihood"))
								{
									bPENALIZEDDEF = true;
								}
								else if (szvalue.equalsIgnoreCase("Train-Test"))
								{
									bPENALIZEDDEF = false;
								}
								else if (!szvalue.equals(""))
						...
						else if ((sztype.equalsIgnoreCase("Delay_path_improvement"))||
								(sztype.equalsIgnoreCase("Delay_split_score_%")))
						{
							dDELAYPATHDEF = Double.parseDouble(szvalue);
							if (dDELAYPATHDEF < 0)
							{
								throw new IllegalArgumentException(szvalue+
										" is an invalid value for "+sztype+" must be >= 0");	 
							}
						}
						else if (sztype.equalsIgnoreCase("Merge_path_score_%"))
						{
						...
						else if (sztype.equalsIgnoreCase("Merge_path_difference_threshold"))
						{
						...
						else if (sztype.equalsIgnoreCase("Delay_split_difference_threshold"))
						{
						...
						else if (sztype.equalsIgnoreCase("Delete_path_difference_threshold"))
						{
						...
						else if (sztype.equalsIgnoreCase("Main_search_difference_threshold"))
						{
						...
						else if ((sztype.equalsIgnoreCase("Prune_path_improvement"))||
								(sztype.equalsIgnoreCase("Delete_path_score_%")))
						{
						...
						else if ((sztype.equalsIgnoreCase("Minimum_score_improvement"))||
								(sztype.equalsIgnoreCase("Main_search_score_%")))
						{
							...
							if (dMinScoreDEF < 0)
							{
								...
								(sztype.equalsIgnoreCase("Saved_Model[Use As Is/Start Search From/Do Not Use]")))
						{
							try
							{
							...
							catch(NumberFormatException ex)
							{
								...
								else if (szvalue.equalsIgnoreCase("Start Search From"))
								{
									ninitsearchDEF = 1;
								}
								else if (szvalue.equalsIgnoreCase("Do Not Use"))
								{
									ninitsearchDEF = 2;
								}
								else if (!szvalue.equals(""))
						...
						else if (sztype.equalsIgnoreCase("Filter_Gene_If_It_Has_No_Static_Input_Data"))
						{
						...
						{
							dMinCorrelationRepeatsDEF = Double.parseDouble(szvalue);
						}
						...
						else if (sztype.equalsIgnoreCase("Only_include_annotations_with_these_taxon_IDs"))
						{
							sztaxonDEF = szvalue;
								...
								(sztype.equalsIgnoreCase("Category_ID_Mapping_File")))
						{
							szcategoryIDDEF = szvalue;
						}
						else if ((sztype.equalsIgnoreCase("GO_Minimum_number_of_genes"))||
								(sztype.equalsIgnoreCase("Minimum_number_of_genes")))
						{
						...
						else if (sztype.equalsIgnoreCase("Minimum_Split_Percent"))
						{
						...
						(sztype.equalsIgnoreCase(
						"Multiple_hypothesis_correction_method[Bonferroni,Randomization]")))
						{
						...
						// TODO Cleanup this parsing to use a properties file
						else if(sztype.equalsIgnoreCase("Active_TF_influence"))
						{
							dProbBindingFunctional = Double.parseDouble(szvalue);
							System.out.println("Setting active TF influence to " + dProbBindingFunctional);
						}
	...
	/**
	 * Checks if the two data sets have the same number of rows, time points, and
	...
	/**
	 * Checks if origcols and nrepeat cols are the same value, the length of origgenes and repeatgenes
	 * is the same, and the gene names are the same
	 */
	...
	synchronized public static DREM_DataSet buildset(
		...
		if (balltime)
		{
			...
			if (theDataSet1.numcols <=1)
			{
				...
				if (theDataSet1.numcols == 1)
				{
					theDataSet1fm = new DREM_DataSet(theDataSet1.filterMissing1point(),theDataSet1.tga);
					theDataSet1fm = new DREM_DataSet(theDataSet1fm.filtergenesthreshold1point(),theDataSet1fm.tga);
				}
				else
				{
			...
			else
			{
				...
				theDataSet1 =  new DREM_DataSet(theDataSet1.logratio2(),theDataSet1.tga);
				theDataSet1 =  new DREM_DataSet(theDataSet1.averageAndFilterDuplicates(),theDataSet1.tga);
				...
				if (numrepeats > 0)
				{
					...
					for (int nset = 0; nset < numrepeats; nset++)
					{
						...
						DREM_DataSet theOtherSet = new DREM_DataSet(szfile, nmaxmissing,
								dexpressedval, dmincorrelation, 
						...
						//normalize the data  
						theOtherSet =  new DREM_DataSet(theOtherSet.logratio2(),theOtherSet.tga);
						theOtherSet =  new DREM_DataSet(theOtherSet.averageAndFilterDuplicates(),theOtherSet.tga);
						//gene values in log ratio before averaging stored

						repeatSets[nset]= theOtherSet; 
					}
					theDataSetsMerged =  new DREM_DataSet(theDataSet1.mergeDataSets(repeatSets),theDataSet1.tga);
					theDataSetsMerged =  new DREM_DataSet(theDataSetsMerged.filterdistprofiles(theDataSet1,repeatSets),
				...
				theDataSetsMerged = new DREM_DataSet(theDataSetsMerged.filterMissing(),theDataSetsMerged.tga);
				theDataSetsMerged = new DREM_DataSet(theDataSetsMerged.filtergenesthreshold2(),theDataSetsMerged.tga);
		...
		else
		{
			...
			else
			{
				...
				theDataSetsMerged = new DREM_DataSet(theDataSetsMerged.logratio2(),theDataSetsMerged.tga);
				theDataSetsMerged = new DREM_DataSet(theDataSetsMerged.averageAndFilterDuplicates(),theDataSetsMerged.tga);
	 ...
	 */
	public void clusterscript(String szstaticFieldval,
			String szxrefval,
			String szexp1val,
			String szgoval, 
			...
			String szextraval, boolean balltime, 
			Vector repeatnames, boolean btakelog,
			boolean bgetxref, boolean bgetgoann,
			boolean bspotincluded, boolean badd0,
			String szcategoryIDval, String szinitfileval,
			String szevidenceval,String sztaxonval,
			boolean bpontoval,boolean bcontoval,
			boolean bfontoval,boolean brandomgoval,boolean bmaxminval) throws Exception
			{
		...
		if (nexceptions == 0)
		{
			...
			{
				throw new IllegalArgumentException("No transcription factor gene interaction input file given!");
			}
			if ((!szstaticFileval.trim().equals(""))&&(!(new File(szstaticFileval)).exists()))
			{
			...
			{
				throw new IllegalArgumentException("No time series input data file given!");
			}
			else if (!(new File(szexp1val)).exists())
			{
				throw new IllegalArgumentException("The time series input data file '"+szexp1val+"' cannot be found."); 
			}
			...
			if (nmingolevel< 1)
			{
				throw new IllegalArgumentException("Minimum number of GO level must be at least 1");
			}
			...
			if ((ninitsearchval!=0)||(szinitfileval.equals("")))
			{
				javax.swing.SwingUtilities.invokeAndWait(new Runnable() 
				{
					public void run() 
					{
						...
						lp.add(new JLabel(" Please wait this may take several minutes..."+
						"                                  "));
						...
						currentButton.addActionListener((ActionListener)thisframe);
						...
						endSearchButton.addActionListener((ActionListener)thisframe);

						lp.add(endSearchButton);
						SpringUtilities.makeCompactGrid(lp,12,1,0,10,0,10);	         
						cp.add(lp);
						executeDialog.pack();
			...
			final DREM_DataSet thefDataSetfmnel  = DREM_IO.buildset(
					...
					dexpressedval, dmincorrelation,
					nsamplespval, nmingo, 
					nmingolevel, szextraval, balltime, 
					repeatnames,btakelog,bspotincluded,badd0,szcategoryIDval,
					szevidenceval,sztaxonval,bpontoval,bcontoval,bfontoval,brandomgoval,bmaxminval);
			...
			thetimehmm = new DREM_Timeiohmm(thefDataSetfmnel,szstaticFileval,
					...
					szdelaypathval, szmergepathval,
					szepsilonvaldiff,szprunepathvaldiff,
					szdelaypathvaldiff, szmergepathvaldiff,
					szseedval,bstaticcheckval,ballowmergeval,
					ninitsearchval, szinitfileval,
					statusLabel,statusLabel15,
					statusLabel2,statusLabel3,statuscountLabel,
					endSearchButton,bstaticsearchval,
					brealXaxisDEF,dYaxisDEF,dXaxisDEF,dnodekDEF,
					nKeyInputTypeDEF,dKeyInputXDEF,
					dpercentDEF,currentButton,"",
					sznodepenaltyval,bpenalizedmodelval,szconvergenceval, dProbBindingFunctional);
			...
			try
			{
				javax.swing.SwingUtilities.invokeAndWait(new Runnable() 
				{
					public void run() 
					{
						...
						final DREMGui theDREMGui = new DREMGui(fthetimehmm,fthetimehmm.treeptr,
								brealXaxisDEF,dYaxisDEF,dXaxisDEF,
								nKeyInputTypeDEF,dKeyInputXDEF,dpercentDEF,"(Final Model)", dnodekDEF);
						edu.umd.cs.piccolo.PCanvas.CURRENT_ZCANVAS = null;
						theDREMGui.setLocation(15,40);
						theDREMGui.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
						...
						theDREMGui.addWindowListener(new WindowAdapter() 
						{
							public void windowClosing(WindowEvent we) 
							{
								...
								if (!theDREMGui.bsavedchange)
								{
									Object[] options = {"Yes",
											"No"};
									int noption = JOptionPane.showOptionDialog(theDREMGui,
									...
									{                 
										...
										{
											theDREMGui.saveModelFrame = new JFrame("Save Model to File");
											theDREMGui.saveModelFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
											theDREMGui.saveModelFrame.setLocation(400,300);
											DREMGui_SaveModel newContentPane = 
												new DREMGui_SaveModel(theDREMGui.theTimeiohmm,theDREMGui.theTimeiohmm.treeptr,
														theDREMGui.saveModelFrame,theDREMGui);
											newContentPane.setOpaque(true); 
											//content panes must be opaque
											theDREMGui.saveModelFrame.setContentPane(newContentPane);
											//Display the window.
											theDREMGui.saveModelFrame.pack();			
										}
										else
										{
											theDREMGui.saveModelFrame.setExtendedState(Frame.NORMAL);
										}
										theDREMGui.saveModelFrame.setVisible(true);
									}
								}
							}
						});     
	...
	public void handlestaticsource()
	{
		...
		{
			staticFileField.setText(SZSTATICDIR+System.getProperty("file.separator")+
	...
	public void handlenxrefval()
	{
		if (xrefcb.getSelectedIndex() >= 0)
		{
			...
			szxrefsourceval = defaultxrefs[nxrefcb];
			if (nxrefcb>=2)
			{
				xrefField.setText(xreffile[nxrefcb]);
			...
			if ((nxrefcb>=2)&&(!xreffile[nxrefcb].equals("")))
			{
				File xrefFile = new File(xreffile[nxrefcb]);
				if (xrefFile.exists())
				{
	...
	public void handlendbval()
	{
		...
		szorganismsourceval = organisms[ndb];
		...
		if (nitems == 1)
		{
			...
			for (int nindex =0 ; nindex < defaultxrefs.length; nindex++)
			{
				xrefcb.addItem(defaultxrefs[nindex]);
			}
		}

		if (xreforgfile[ndb].equals(""))
		{
			if (ndb==1)
			{
				xrefcb.removeAllItems();
				xrefcb.addItem(defaultxrefs[1]);
		...
		{
			xrefcb.setSelectedItem(organisms[ndb]);
		}
		...
		{
			File goannFile = new File(gannfile[ndb]);
			if (goannFile.exists())
			{
				anncheck.setSelected(false);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			bendsearch = true;
			statusLabel2.setText(" End Search Requested. Search Will End Soon. ");
		...
		else if (esource == viewstaticButton)
		{
			...
			if ((new File(szfile)).exists())
			{
				javax.swing.SwingUtilities.invokeLater(new Runnable() 
				{
					public void run() 
					{
						DataTable newContentPane = new DataTable(fframe,szfile,true);
		...
		else if (esource == clusterAButton)
		{
			...
			if (obocheck.isSelected())
			{
				...
				Runnable runpd= new Progressdownload(this,2,szgocategoryval);
				(new Thread(runpd)).start();
			}
				...
				public void run()
				{
					...
					try
					{
						clusterscript(szstaticFileval, szxrefval,szorig1val,
								...
								bgetxref, bgetgoann,bspotincluded,badd0,szcategoryIDval,szinitfileval,
								szevidenceval,sztaxonval,bpontoval,bcontoval,bfontoval,brandomgoval,bmaxminval);
					}
					catch(IllegalArgumentException iex)
					{
		...
		{
			String szMessage = "This is version 1.0.6b of the Dynamic Regulatory Events Miner (DREM).\n\n"+
			"The Dynamic Regulatory Events Miner (DREM) was developed by Jason Ernst "+
			"in collaboration with Ziv Bar-Joseph.  Any questions or bugs found should "+
			"be emailed to jernst@cs.cmu.edu.";
			...
			Util.renderDialog(this,szMessage,50,100,"Information");
				...
				(delaypathHButton==esource)||
				(epsilonHButton==esource)||
	...
	/**
	 * Download the data at the location of szURL into a file szoutfile
	 * ntype is used for updating the download progress percentages
	 */
	...
	public class Downloadfile implements Runnable
	{
		...
		public void run()
		{
			...
			if (ntype == 0)
			{ 
				if (szfile.equals(SZGP+"goa_arabidopsis.gz"))
				{
					szurl = EBIURL+"ARABIDOPSIS/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_chicken.gz"))
				{
					szurl = EBIURL+"CHICKEN/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_human.gz"))
				{
					szurl = EBIURL+"HUMAN/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_mouse.gz"))
				{
					szurl = EBIURL+"MOUSE/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_pdb.gz"))
				{
					szurl = EBIURL+"PDB/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_rat.gz"))
				{
					szurl = EBIURL+"RAT/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_uniprot.gz"))
				{
					szurl = EBIURL+"UNIPROT/"+szfile;
				}
				else if (szfile.equals(SZGP+"goa_zebrafish.gz"))
				{
	...
	public  void makeHelpDialog(Component esource)
	{
		...
		{
			szMessage =
				"  Pressing the 'Options' button opens a dialog box with "+
	...
	protected JComponent makeAdditionalSearchPanel()
	{
		...
		SpinnerNumberModel snnodepenalty = new SpinnerNumberModel(new Double(dNODEPENALTYDEF),
				new Double(0),null,new Double(5));
		...
		SpinnerNumberModel snepsilon = new SpinnerNumberModel(new Double(dMinScoreDEF),
				new Double(0),null,new Double(.01));
		...
		SpinnerNumberModel snprunepath = new SpinnerNumberModel(new Double(dPRUNEPATHDEF),
				new Double(0),null,new Double(.01));
		...
		SpinnerNumberModel sndelaypath = new SpinnerNumberModel(new Double(dDELAYPATHDEF),
				new Double(0),null,new Double(.01));
		...
		SpinnerNumberModel snmergepath = new SpinnerNumberModel(new Double(dDMERGEPATHDEF),
				new Double(0),null,new Double(.01));
		...
		SpinnerNumberModel snepsilondiff = new SpinnerNumberModel(new Double(dMinScoreDIFFDEF),
				new Double(0),null,new Double(.01));
		...
		SpinnerNumberModel snprunepathdiff = new SpinnerNumberModel(new Double(dPRUNEPATHDIFFDEF),null,
				new Double(0),new Double(.01));
		...
		SpinnerNumberModel sndelaypathdiff = new SpinnerNumberModel(new Double(dDELAYPATHDIFFDEF),null,
				new Double(0),new Double(.01));
		...
		SpinnerNumberModel snmergepathdiff = new SpinnerNumberModel(new Double(dDMERGEPATHDIFFDEF),null,
				new Double(0),new Double(.01));
	...
	/**
	 * Toggles which model selection variables are enabled based on the value of btraintest
	 */
	...
	protected JComponent makeSearchPanel()
	{
		...
		SpinnerNumberModel snseed = new SpinnerNumberModel(new Integer(nSEEDDEF),new Integer(0),
				null,new Integer(1));
		...
		SpinnerNumberModel snnumchild = new SpinnerNumberModel(new Integer(numchildDEF),new Integer(2),
				null,new Integer(1));
		...
		SpinnerNumberModel snconvergence = new SpinnerNumberModel(new Double(dCONVERGENCEDEF),new Double(0.0001),
				null,new Double(0.001));
	...
	// TODO figure out the best way to make this work
	/**
	 * Run DREM in batch mode programmatically.
	 * @param defaults the file specifiying all parameter values.
	 * @param bindFile the TF-gene binding data (optionaly with priors)
	 * @param outputFile the filename that will be used when saving the model and
	 * TF activity scores
	 * @deprecated Replaced by DREM_IO_Batch
	 */
	public static void batchMode(String defaults, String bindFile, String outputFile)
		throws IOException, FileNotFoundException
	{
		// The active TF inluence parameter is specified in the DREM defaults file
	...
	public static void main(String[] args) throws Exception{
		...
		if (bshowusage)
		{
			System.out.println("USAGE: java -jar drem.jar [-d defaultfilename.txt]");
			return;
		}
