 ...
 */
public class DREMGui_DefineGeneSet extends JPanel implements ItemListener, ActionListener, ChangeListener
{
	 ...
	 */
	  ...
	  */
	 void setGeneSetLabelTextColor(DREM_Timeiohmm.Treenode treeptr, Color newColor)
	 {
		 if (treeptr != null)
		 {
	 ...
	 /**
	  * Adds label for enrichment of the selected set of genes for paths or splits
	 ...
	 public void addSetLabels(DREM_Timeiohmm.Treenode treeptr)
	 {
		 if ((treeptr != null)&&(bapplyset))
		 {
			 ...
			 if (!bsplitgolabels)
			 {
				 ...
				 if (dpval <= dsetpval)
				 {
					 treeptr.szgenesetlabel = nmatch+";"+Util.doubleToSz(dpval);
				 }
				 else
				 {
	 ...
	 public void stateChanged(ChangeEvent e) 
	 {
		 ...
		 if (!source.getValueIsAdjusting()) 
		 {
			 ...
			 pvalLabel.setText("X = "+source.getValue()/10.0+
					 "; p-value threshold is "+DREMGui_KeyInputs.doubleToSz(dsetpval));
			 addSetLabels(rootptr);
		 }
	 }
	 ...
	 void loadTFGeneList()
	 {
		 //add space here
		 hsList = new HashSet();
		 for (int ninput = 0; ninput < theDREMGui.theTimeiohmm.tfNames.length; ninput++)
		 {
			 String sztf = theDREMGui.theTimeiohmm.tfNames[ninput].toUpperCase(Locale.ENGLISH);
	 ...
	 boolean handleInputTF(String szname)
	 {
		 ...
		 else
		 {
			 ...
			 while (st.hasMoreTokens())
			 {
				 ...
				 {
					 StringTokenizer stu = new StringTokenizer(sztoken,"_");
					 if ((stu.countTokens() > 1)&&(hsList.contains(stu.nextToken())))
					 {
						 hsTFGeneList.add(szname);
					 }
				 }
	 ...
	 void setComplement()
	 {
		 ...
		 {
			 tms.setValueAt(Boolean.valueOf(!((Boolean) tms.getValueAt(nrow,2)).booleanValue()), 
					 nrow, 2);
		 }
	 }
	  ...
	  */
	 void setGeneSetLabelTextVisible(DREM_Timeiohmm.Treenode treeptr, boolean bvisible)
	 {
		 if (treeptr != null)
		 {
	 ...
	 public void actionPerformed(ActionEvent e) 
	 {
		 ...
		 else if (szcommand.equals("unapply"))
		 {
			 ...
			 for (int ngene = 0; ngene < theDREMGui.bSetVisible.length; ngene++)
			 {
				 ...
				 theDREMGui.bGOVisible[ngene]&& theDREMGui.bTFVisible[ngene];
		 ...
		 else if ((szcommand.equals("load"))||(szcommand.equals("query")))
		 {
					 ...
					 ||(szcommand.equals("query")))
			 {
				 ...
				 for (int ngene = 0; ngene < genenames.length; ngene++)
				 {
					 ...
					 {
						 theDREMGui.bSetVisible[ngene] = true;
						 boolean bvisible = theDREMGui.bglobalVisible&&theDREMGui.bGOVisible[ngene]
						                                                                     && theDREMGui.bPathVisible[ngene]&& theDREMGui.bTFVisible[ngene];
						 theDREMGui.plArray[ngene].setVisible(bvisible); 
						 theDREMGui.plArray[ngene].setPickable(bvisible); 
					 }
					 else
				 ...
				 setGeneSetLabelTextVisible(rootptr,theDREMGui.bshowgenesetlabels &&
		 ...
		 {
			 String szMessage = 
				 "The above dialog allows a user to select a subset of genes based on the gene names.  "+
	 ...
	 private void makewindow()
	 {
		 ...
		 JLabel theTopLabel = new JLabel("  Only display enrichments with a p-value less than 10^-X where X is:");
		 ...
		 pvalLabel = new JLabel("X = "+ninitval/10.0+
				 "; p-value threshold is "+ DREMGui_KeyInputs.doubleToSz(Math.pow(10,-ninitval/10.0)));
